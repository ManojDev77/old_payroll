...
// import 'package:payroll/widgets/slidable.dart';
// import 'package:payroll/widgets/slide_action.dart';
// import 'package:payroll/widgets/slidable_action_pane.dart';
// import 'dart:convert';
// import 'dart:async';
...
// class EXtimeReportPage extends StatefulWidget {
//   static const title = 'Leave';
//   static const androidIcon = Icon(Icons.receipt);

//   @override
//   _EXtimeReportPageState createState() => _EXtimeReportPageState();
// }

// class _EXtimeReportPageState extends State<EXtimeReportPage>
//     with WidgetsBindingObserver {
//   Color primaryColor = Color.fromRGBO(30, 144, 255, 1);
...
//       var mainList = list.map((e) => new InvoiceListModel.fromJson(e)).toList();
...
//         key: _scaffoldKey,
//         appBar: AppBar(
//           title: Text("Employee Leave Report"),
//         ),
//         body: SafeArea(
//           child: Column(
...
//     });
//     if (text.length != 0 || searchcontroller.text.isNotEmpty) {
...
//   Widget _buildItem(InvoiceListModel user, [int index]) {
//     return Text('s');
//     // return Column(
//     //   children: <Widget>[
//     //     Padding(
...
//       id: json['BillID'] == null ? 0 : json['BillID'],
...
//       partyname: json['empname'] == null ? "" : json['empname'],
//       reason: json['reason'] == null ? "" : json['reason'],
//       type: json['listdesc'] == null ? "" : json['listdesc'],
//     );
//   }
...
//     String orderDate = new dateformat.DateFormat("dd/MM/yyyy").format(orDate);
//     return orderDate;
//   }
// }
